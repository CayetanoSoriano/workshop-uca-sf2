...
namespace workshop\AdminBlogBundle\Controller;
...
use workshop\BlogBundle\Form\CategoryType;
...
class CategoryController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('workshopBlogBundle:Category')->findAll();
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('workshopBlogBundle:Category')->find($id);
     ...
     * @Method("POST")
     * @Template("workshopBlogBundle:Category:new.html.twig")
     */
     ...
     * @Method("POST")
     * @Template("workshopBlogBundle:Category:edit.html.twig")
     */
