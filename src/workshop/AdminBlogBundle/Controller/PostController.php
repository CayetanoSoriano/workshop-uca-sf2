...
class PostController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('workshopBlogBundle:Post')->findAll();
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('workshopBlogBundle:Post')->find($id);
     ...
     * @Method("POST")
     * @Template("workshopBlogBundle:Post:new.html.twig")
     */
     ...
     * @Method("POST")
     * @Template("workshopBlogBundle:Post:edit.html.twig")
     */
